<template>
  <div class="component-icon-1x4" v-bind:class='{"edit": isEdit, "preview": isPreview}' @click="editComponent($event)">
...
<script>
  ...
  import imageIconOneFour from '../assets/tpl-image/icon1x4.png';
