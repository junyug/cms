<template>
  <div class="component-text_title_1" v-bind:class='{"edit": isEdit, "preview": isPreview}' @click="editComponent">
...
<script>
  ...
  import imageText from '../assets/tpl-image/text_title_1.png';
