<template>
  <div class="component-img-2xn_1" v-bind:class='{"edit": isEdit, "preview": isPreview}' @click="editComponent($event)">
...
<script>
  ...
  import imageOneTwoOne from '../assets/tpl-image/image1x2_1.png';
