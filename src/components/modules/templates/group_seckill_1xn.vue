<template>
    <div class="component-good-seckill" :class='{"edit": isEdit, "preview": isPreview}' @click="editComponent($event)">
...
<script>
  ...
  import previewImage from '../assets/tpl-image/group_seckill_1xn.png';
