<template>
  <div class="component-img-3xn" v-bind:class='{"edit": isEdit, "preview": isPreview}' @click="editComponent($event)">
...
<script>
  ...
  import imageOneThree from '../assets/tpl-image/image1x3.png';
