<template>
    <div class="component-good-1xn" v-bind:class='{"edit": isEdit, "preview": isPreview}' @click="editComponent($event)">
...
<script>
  ...
  import previewImage from '../assets/tpl-image/good_1xn.png';
